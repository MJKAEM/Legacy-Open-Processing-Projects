...
public class Circle
{
  ...
  {
    if (GetPosition().x < aSquare.GetPosition().x + (aSquare.GetSideLength() / 2) && GetPosition().y >= aSquare.GetPosition().y + (aSquare.GetSideLength() / 2))
    {
      for (int i = 89; i >= 0; --i)
      {
        double PosX = GetPosition().x + ((GetRadius() + GetStrokeSize()) * Math.cos(Math.toRadians(i)));
        double PosY = GetPosition().y - ((GetRadius() + GetStrokeSize()) * Math.sin(Math.toRadians(i)));

        if (aSquare.GetPosition().x <= PosX && aSquare.GetPosition().y + aSquare.GetSideLength() >= PosY)
        {
          return true;
        }
      }
    }
    else if (GetPosition().x >= aSquare.GetPosition().x + (aSquare.GetSideLength() / 2) && GetPosition().y > aSquare.GetPosition().y + (aSquare.GetSideLength() / 2))
    {
      for (int i = 89; i >= 0; --i)
      {
        double PosX = GetPosition().x - ((GetRadius() + GetStrokeSize()) * Math.cos(Math.toRadians(i)));
        ...
        if (aSquare.GetPosition().x + aSquare.GetSideLength() >= PosX && aSquare.GetPosition().y + aSquare.GetSideLength() >= PosY)
        {
          return true;
        }
      }
    ...
    else if (GetPosition().x > aSquare.GetPosition().x + (aSquare.GetSideLength() / 2) && GetPosition().y <= aSquare.GetPosition().y + (aSquare.GetSideLength() / 2))
    {
      for (int i = 89; i >= 0; --i)
      {
        ...
        if (aSquare.GetPosition().x + aSquare.GetSideLength() >= PosX && aSquare.GetPosition().y <= PosY)
        {
          return true;
        }
      }
    ...
    else if (GetPosition().x <= aSquare.GetPosition().x + (aSquare.GetSideLength() / 2) && GetPosition().y < aSquare.GetPosition().y + (aSquare.GetSideLength() / 2))
    {
      for (int i = 89; i >= 0; --i)
      {
        ...
        if (aSquare.GetPosition().x <= PosX && aSquare.GetPosition().y <= PosY)
        {
          return true;
        }
      }
